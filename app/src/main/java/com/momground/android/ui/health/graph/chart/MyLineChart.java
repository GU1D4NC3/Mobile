...
class MyLineChart extends LineRadarRenderer {
    ...
    MyLineChart(LineDataProvider chart, ChartAnimator animator,
    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        final boolean isDrawSteppedEnabled = false;
        final int pointsPerEntryPair = 4;
    ...
    private Path mGenerateFilledPathBuffer = new Path();
     ...
     */
    HashMap<IDataSet, DataSetImageCache> mImageCaches = new HashMap<>();
